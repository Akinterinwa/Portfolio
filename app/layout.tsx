...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://akinterinwa-oluwanifemi.vercel.app/my-image.png", // Replace with a URL to an attractive image for social sharing
      },
    ],
  },
  twitter: {
    ...
    title: "Akinterinwa Oluwanifemi | Full-Stack Developer Portfolio",
    description: "Explore the portfolio of Akinterinwa Oluwanifemi, a passionate full-stack developer with expertise in building modern web applications. Discover my projects, skills, and professional experience.",
    images: ["https://akinterinwa-oluwanifemi.vercel.app/my-image.png"], // Replace with a URL to an attractive image for Twitter sharing
  },
};
